...
class ValueOfConversionExprFactoryTest extends RapierTestBase {
  ...
  @Test
  void givenClassWithMatchingValueOfMethod_whenCompile_thenGenerateExpectedConversionExpr()
      throws IOException {
    ...
    assertEquals("com.example.TestClass.valueOf(value)", conversionExpr);
  }

  @Test
  void givenClassWithNonMatchingParameterTypeValueOfMethod_whenCompile_thenGenerateNoConversionExpr()
      throws IOException {
    final JavaFileObject testAnnotationSource = prepareSourceFile("""
        package com.example;
  ...
  @Test
  void givenClassWithNonMatchingReturnTypeValueOfMethod_whenCompile_thenGenerateNoConversionExpr()
      throws IOException {
    final JavaFileObject testAnnotationSource = prepareSourceFile("""
        package com.example;
  ...
  @Test
  void givenClassWithoutValueOfMethod_whenCompile_thenGenerateNoConversionExpr()
      throws IOException {
    final JavaFileObject testAnnotationSource = prepareSourceFile("""
        package com.example;
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment round) {
      ...
      for (Element annotatedElement : annotatedElements) {
        if (!annotatedElement.getKind().isClass())
          continue;
        conversionExpr = new ValueOfConversionExprFactory(getTypes(), getIntegerType())
