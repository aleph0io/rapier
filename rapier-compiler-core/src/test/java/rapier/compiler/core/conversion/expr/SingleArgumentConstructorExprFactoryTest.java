...
class SingleArgumentConstructorExprFactoryTest extends RapierTestBase {
  private String conversionExpr;

  @BeforeEach
  public void setupSingleArgumentConstructorExprFactoryTest() {
    conversionExpr = null;
  }

  @Test
  void givenClassWithMatchingSingleArgumentConstructor_whenCompile_thenGenerateExpectedConversionExpr()
      throws IOException {
    ...
    assertEquals("new com.example.TestClass(value)", conversionExpr);
  }

  @Test
  void givenClassWithNonMatchingSingleArgumentConstructor_whenCompile_thenGenerateNoConversionExpr()
      throws IOException {
    final JavaFileObject testAnnotationSource = prepareSourceFile("""
        package com.example;
  ...
  @Test
  void givenAbstractClassWithMatchingSingleArgumentConstructor_whenCompile_thenGenerateNoConversionExpr()
      throws IOException {
    final JavaFileObject testAnnotationSource = prepareSourceFile("""
        package com.example;
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment round) {
      ...
      for (Element annotatedElement : annotatedElements) {
        if (!annotatedElement.getKind().isClass())
          continue;
        conversionExpr =
            new SingleArgumentConstructorConversionExprFactory(getTypes(), getIntegerType())
                .generateConversionExpr(annotatedElement.asType(), "value")
                .orElse(NO_CONVERSION_EXPR);
      }
